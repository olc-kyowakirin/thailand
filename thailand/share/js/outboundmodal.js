    ...
    * ======================================== */
    (function ($) {
        var whiteListHost = [ // モーダルを表示させないhostname + directore
            ...
            'm.kirin.co.jp',
            'www.kyowakirin.com/overview',
            'www.kyowakirin.com/media_center',
            'www.kyowakirin.com/asiapacific/',
        ];
        ...
        var modalContentTmp = {
            type01: '<div class="box-text"><p>You will be accessing an external site.</p><p>Click "OK" to continue.</p></div><div class="align-c"><a href="{{href}}" target="_blank" class="btn-03 btn-small">OK<img src="https://www.kyowakirin.com/thailand/share/images/icon_link_blank_04.png" alt="Open in new window" class="icon-blank"></a></div>',
            type02: '<div class="box-text mb-0"><p><em>Président</em></p><p>Ben Forward</p><p><em>Pour toute déclaration d’effet indésirable, contactez</em></p><p>pvfrance@kyowakirin.com</p><p><em>Pour toute demande d’information médicale, contactez</em></p><p>Infomed-FR@kyowakirin.com</p></div>',
