...
$(function() {
    if (0 < $("#over_view").length) {
        var f = -1 != navigator.userAgent.toLowerCase().indexOf("msie 6"),
            j = -1 != navigator.userAgent.toLowerCase().indexOf("msie 7"),
            e = $("#over_view #container"),
            d = $("#recent_changes #container"),
            g = "";
        ...
        e.isotope({
            ...
            getSortData: {
                compound: function(a) {
                    var b = a.find(".compound").html();
                    if ("&nbsp;" == b || "-&nbsp;" == b) b = "ZZZZZ&nbsp;";
                    return b += a.find(".compound").siblings("span").text()
                },
                phase: function(a) {
                    a = a.find(".head04 p").attr("class").split(/p/);
                    return f || j ? a : a[1]
                }
            }
        });
        $("#options .option-set a").click(function(event) {
            event.preventDefault();
            var a = {},
                b = $(this).attr("href").split(/\=/)[1];
            g != b && (g = b, a.sortBy = b);

            "phase" == b ? (a.sortAscending = $(this).hasClass("asc") ? !0 : !1, e.isotope(a), !0 === a.sortAscending ? $(this).removeClass("asc").addClass("desc") : $(this).removeClass("desc").addClass("asc")) : (a.sortAscending = $(this).hasClass("asc") ? !1 : !0, e.isotope(a), !0 === a.sortAscending ? $(this).removeClass("desc").addClass("asc") : $(this).removeClass("asc").addClass("desc"));
            return !1
        });
        $("#over_view #container .element a.compound").click(function() {
            var a = $(this).parents().parents().siblings(".open");
            a.is(":hidden") ? (a.fadeIn(700), e.isotope("reLayout"), a.parents(".element").addClass("current")) : (a.fadeOut("fast", function() {
                e.isotope("reLayout")
        ...
        $("table.filter input").click(function() {
            var a = $(this).attr("name"),
                ...
                c = "",
                d = {
                    modalities: "therapeuticarea",
                    therapeuticarea: "modalities"
                };
            switch (a) {
                case "modalities_all":
                case "therapeuticarea_all":
                    ...
                    $("input[name=" + d[c] + "]:checked").each(function() {
                        b.push("." + $(this).val())
                    });
                    c = ",";
                    break;
                default:
                    $c = $("input[name=" + a + "]:checked"), 0 === $c.length ? ($("input[name=" + a + "_all]").attr("checked", !0), $("input[name=" + d[a] + "]:checked").each(function() {
                        b.push("." + $(this).val())
                    })) : ($("input[name=" + a + "_all]").attr("checked", !1), $("input[name=" + a + "]:checked").each(function() {
                        var c = "." + $(this).val();
                        0 < $("input[name=" + d[a] + "]:checked").length ? $("input[name=" + d[a] + "]:checked").each(function() {
                            b.push(c + "." + $(this).val())
                        }) : b.push(c)
                    })), c = ","
            }
            var f = "",
                f = 0 == b.length ? "*" : b.join(c);
            e.isotope({
                filter: f
            })
        });
        ...
        $("#recent_changes #container .element a.compound").click(function() {
            var a = $(this).parents().parents().siblings(".open");
            a.is(":hidden") ? (a.fadeIn(700), d.isotope("reLayout"), a.parents(".element").addClass("current")) : (a.fadeOut("fast", function() {
                d.isotope("reLayout")
            }), a.parents(".element").removeClass("current"));
            return !1
        });
        ...
        f && $("#over_view #container div.element, #recent_changes #container div.element").hover(function() {
            $(this).css("background", "#e7e5e3 url(/share/images/bg_overview_data01.gif) repeat-x")
        }, function() {
            $(this).css("background", "")
        });
        $("#recent_changes,#dev_date").hide()
    } else if (0 < $("#news_releases_isotope").length) {
        var h = $("#news_releases_isotope #container");
        h.isotope({
            itemSelector: ".element",
            layoutMode: "straightDown",
            animationEngine: "best-available"
        ...
        $("#searchArea #btnSearch").click(function() {
            ...
            $("#searchArea ul.category input:checked").each(function() {
                b.push(c + "." + $(this).attr("id"))
            });
            a = 0 === b.length && 0 === c.length ? "*" : 0 === b.length ? c : b.join(",");
            h.isotope({
                filter: a
            });
            0 == $("#container").data("isotope").$filteredAtoms.filter(".element").length ? $("#error").show() : $("#error").hide()
        });
